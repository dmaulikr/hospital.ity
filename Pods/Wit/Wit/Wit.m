...
- (void) interpretString: (NSString *) string customData:(id)customData withBlock: (void (^) (NSString * intent)) block {
    ...
    __block NSString *returnedWitIntent = nil;
    [NSURLConnection sendAsynchronousRequest:req
                           ...
                           completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
                               ...
                               if (object[@"outcomes"][0][@"entities"][@"intent"][0][@"value"] != nil) {
                                   NSLog(@"WIT.AI INTENT: %@", object[@"outcomes"][0][@"entities"][@"intent"][0][@"value"]);
                                   //block(object[@"outcomes"][0][@"entities"][@"intent"][0][@"value"]);
                               }
                               else {
                                   NSLog(@"WIT.AI INTENT: %@", object[@"outcomes"][0][@"entities"]);
                               }
                               //returnedWitIntent = object[@"outcomes"][0][@"entities"][@"intent"][0][@"value"];
                               //NSLog(@"WIT.AI NTENT: %@", object)
                               //returnedWitIntent = object[@"outcomes"][@"entities"][@"value"];
    ...
    //NSLog(@"RETURNED WIT INTENT: %@", returnedWitIntent);
    //return returnedWitIntent;
}
